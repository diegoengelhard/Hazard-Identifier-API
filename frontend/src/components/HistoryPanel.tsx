  ...
  return (
    <div className="bg-white p-6 rounded-lg shadow-md h-full flex flex-col">
      ...
      <div className="flex-grow overflow-hidden">
        {/* Inner scroll area with sticky header; height calibrated to viewport minus surrounding cards */}
        <div className="h-full overflow-y-auto max-h-[calc(100vh-340px)] pr-2">
          {history.length === 0 ? (
